...
if(isset($_POST['send'])) {
  ...
  $sql = "INSERT INTO `tblist` (`subject`) VALUES ('$subject')";
  if($db->query($sql)) {
...
<div class="bg-gray-50 dark:bg-gray-900 h-screen">
	<nav class="w-full text-white bg-gray-800 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-primary-800">
